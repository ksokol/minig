 ...
 * @since Jan 29, 2006
 */
public class PatchedGreenMailUtil {
    /**
    ...
    private static PatchedGreenMailUtil instance = new PatchedGreenMailUtil();

    private PatchedGreenMailUtil() {
        // empty
    }

    public static PatchedGreenMailUtil instance() {
        return instance;
    }
    ...
    public static void sendAttachmentEmail(String to, String from, String subject, String msg, final byte[] attachment,
            final String contentType, final String filename, final String description, final ServerSetup setup) throws MessagingException,
            IOException {
        Session session = getSession(setup);
