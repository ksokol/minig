...
public class PatchedCommandParser {
    ...
    /**
     * Reads a "date-time" argument from the request. TODO handle timezones
     * properly
     */
    ...
    public void setFlag(String flagString, Flags flags) throws ProtocolException {
        ...
        // else if (flagString.equals("$Forwarded")) {
        // Flags forwardedFlag = new Flags("$Forwarded");
        // flags.add(forwardedFlag);
        // } else if (flagString.equals("$MDNSent")) {
        // Flags mdnSentFlag = new Flags("$MDNSent");
        // flags.add(mdnSentFlag);
        // }
        else {
            Flags mdnSentFlag = new Flags(flagString);
            flags.add(mdnSentFlag);
