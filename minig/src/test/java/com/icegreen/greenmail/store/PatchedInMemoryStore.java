...
public class PatchedInMemoryStore implements Store, ImapConstants {
    ...
    static {
        ...
        PERMANENT_FLAGS.add(new Flags("$Forwarded"));
        PERMANENT_FLAGS.add(new Flags("$MDNSent"));
    }
    ...
    private class HierarchicalFolder implements MailFolder {
        ...
        /**
         * Returns the 1-based index of the first unseen message. Unless there
         * are outstanding expunge responses in the ImapSessionMailbox, this
         * will correspond to the MSN for the first unseen.
         */
        ...
        private void deleteMessage(int msn) {
            mailMessages.remove(msn - 1); // NOTE BY WAEL: is this really
                                          // correct, the number of items in the
                                          // iterating list is changed see
                                          // expunge()
        }
