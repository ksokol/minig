...
public class FolderRepositoryImplTest {
	...
	public void testGetInbox() {
		assertEquals(mockMailAuthentication.getInboxFolder(), uut.getInbox()
				.getId());
	}
	...
	public void testDelete_emptyFolderWithChildFolder() {
		...
		List<MailFolder> findBySubscribed = uut.findAll();
		assertEquals(3, findBySubscribed.size());
	...
	public void testUpdate_noModification() {
		...
		MailFolder mailFolder = uut.findBySubscribed(false).get(1);
		...
		mailFolder = uut.findBySubscribed(false).get(1);
