...
//    private View ui;
//
//    public UndoMoveWidget(View ui, final String origFolder, String currentFolder, final List<MessageId> newIds) {
//        this.ui = ui;
...
//                undoLabel = I18N.strings.conversationMoveTo(ui.displayName(currentFolder));
//            } else {
//                undoLabel = I18N.strings.conversationsMoveTo(Integer.toString(newIds.size()),
//                        ui.displayName(currentFolder));
//            }
//        }
//        add(new Label(undoLabel));
//        if (!origFolder.startsWith("search:") && newIds != null && !newIds.isEmpty()) {
...
//    }
//
//    public UndoMoveWidget(View ui, final String origFolder, final List<ConversationId> newIds) {
...
//    }
//
//    private void undoMove(final Widget notif, final Folder moveTo, List<MessageId> newIds) {
//        AsyncCallback<List<MessageId>> ac = new AsyncCallback<List<MessageId>>() {
//            public void onFailure(Throwable caught) {
//                ui.getSpinner().stopSpinning();
//                ui.log("Error moving conversations", caught);
//            }
//
//            public void onSuccess(List<MessageId> result) {
//                ui.getSpinner().stopSpinning();
...
//        AjaxCall.store.moveConversation(moveTo, newIds, true, ac);
//    }
//
// }
