 ...
 * 
 */
public class ConversationListActionsPanel extends DockPanel implements IConversationSelectionChangedListener,
    ...
    public void selectionChanged(Set<String> selectedIds) {
    ...
    public void folderSelected(IFolder f) {
        ...
        // || folderName.equals(template) || folderName.equals(draft)) {
